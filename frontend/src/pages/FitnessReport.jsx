...
import FitnessPreview from '../components/FitnessPreview';
...
function FitnessReport() {
  ...
  const generatePDF = () => {
    ...
    const options = {
      filename: "fitness_certificate.pdf",
  ...
  const handleSubmit = async () => {
    try {
      ...
      const newCertificateId = `FIT-${Date.now()}`;
      setCertificateId(newCertificateId);

      setProgress(30);
      setProgressMessage("Generating fitness certificate...");
      ...
      await addDoc(collection(Firestore, "fitnessCertificates"), certificateData);
      ...
      console.error("Error submitting fitness certificate:", error);
      toast.error("Failed to generate fitness certificate");
    } finally {
      ...
      <div className="container mx-auto p-4">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-1/2 bg-white rounded-lg shadow-md p-6">
            ...
            <FitnessForm formData={formData} onChange={setFormData} />
          </div>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 ">
            <div className="bg-white rounded-lg p-6 max-w-lg mx-auto ml-10 mr-10">
              ...
              <p>Are you sure you want to generate this fitness certificate?</p>
